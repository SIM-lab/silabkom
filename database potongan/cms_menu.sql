...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 01, 2020 at 09:23 AM
...
(88, 'tambah_user', 'Tambah User', '', '+1+', 'cms/manage/form_add_user', 1, 1, 3),
(102, 'log', 'Log System', 'Log System', '+1+2+3+4+5+', 'cms/catatan/catat', 1, 2, 1),
...
(173, 'periode_pengajuan', 'Pengajuan', '', '+1+2+3+4+5+6+', 'pengajuan/periode_pengajuan', 1, 1, 4),
(174, 'pengajuan_bahan', 'Pengajuan Bahan', 'Pengajuan Bahan', '+1+2+3+4+5+6+', 'pengajuan/pengajuan_bahan', 1, 2, 4),
(175, 'pengajuan_alat', 'Pengajuan Alat', 'Pengajuan Alat', '+1+2+3+4+5+6', 'pengajuan/pengajuan_alat', 1, 3, 4),
(176, 'jatuh_tempo', 'Jatuh Tempo', '', '+1+2+3+4+5+6+7+', 'peminjaman/jatuh_tempo', 1, 1, 5),
(177, 'user', 'User', '', '+1+', 'cms/user', 1, 1, 6),
(178, 'modul', 'Modul', 'modal modul', '+1+2+3+4+5+6+7+', 'master/modul', 1, 10, 2),
...
(181, 'laboratorium', 'Laboratorium', '', '+1+2+3+4+5+6+7+', 'kelola/laboratorium', 1, 2, 6),
