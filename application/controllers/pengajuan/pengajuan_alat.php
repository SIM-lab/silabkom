...
class Pengajuan_alat extends CI_Controller {
	...
	public function show_addForm()
	{
		...
		{
			$datapost = get_post_data(array('id_pengajuan_alat','nama_alat','seri','merk','harga','jumlah','status'));
	...
	public function show_editForm($id='')
	{
		...
		{
			$datapost = get_post_data(array('id_pengajuan_alat','nama_alat','seri','harga','jumlah','status'));
