  ...
  <body class="hold-transition login-page">
    <div class="login-box">
      ...
      <?php echo form_error('captcha', '<span class="error-span">', '</span>'); ?>
          ...
          <div class="row">
          <div class="col-xs-6">
         <?php echo button('load_silent("cms/lupa","#content")','Lupa Password ? ' ,' btn');?> 
         <!--<a href="https://api.whatsapp.com/send?phone=628813792426&text=Saya%20lupa%20password.%20Tolong%20saya." target="_blank"> Lupa Password ?  </!--> <!-- Bersifat sementara --->
          </div> 
            <div class="col-xs-6">
