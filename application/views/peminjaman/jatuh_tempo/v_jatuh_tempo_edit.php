...
<div class="box-body big">
    ...
    <div class="form-group">
        ...
        <?php echo form_error('tanggal_pinjam');?>
            ...
            <div class="col-sm-8">
            <?php echo form_input(array('name'=>'status_peminjaman','value'=>$row->status_peminjaman,'class'=>'form-control'));?>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
            <?php echo form_input(array('name'=>'cetak','value'=>$row->cetak,'class'=>'form-control'));?>
