        ...
        <div class="box box-primary">
          ...
          <tr>
            ...
            <?php
              ...
              ?>
              <a href="<?= site_url("master/kategori_alat_bahan/delete/".$row->id."","#modal") ?>" class="btn btn-danger fa fa-trash"
              onclick="return confirm('Apa anda Yakin Menghapus kategori alat bahan ?')">
              </a>
            </td>
          </tr>
